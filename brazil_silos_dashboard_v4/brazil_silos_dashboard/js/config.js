...
const FIELDS = {
  ...
  stateName: 'estado',  // full state name (e.g. "Bahia")
  region: 'regiao',     // Brazilian macro-region
  matopiba: 'matopiba', // MATOPIBA membership ("Sim"/"Não")
  type: 'tipo',
  capacity: 'capacidade_t',
  lat: 'lat',
  lon: 'lon',
};
...
/** UF code -> full state name (for tooltips / labels). */
const UF_NAMES = {
  AC: 'Acre',
  AL: 'Alagoas',
  AM: 'Amazonas',
...
const CHARTS = {
  ...
  areaState: '#2f7d4f',
  areaStateFill: 'rgba(47, 125, 79, 0.22)',
  areaCity: '#3d6ea5',
  areaCityFill: 'rgba(61, 110, 165, 0.22)',
  grid: '#ececec',
  ink: '#6b7280',
  ...
  // Município area chart: show the top N by aggregate capacity (36 distinct
  // municipalities total). State chart shows all states.
  topMunicipios: 20,
};
...
const VIZ = {
  ...
  treemap: {
    regionColors: { 'Nordeste': '#2f7d4f', 'Norte': '#3d6ea5' },
    fallback: '#c9962f',
    gap: 3,
  },
  /**
