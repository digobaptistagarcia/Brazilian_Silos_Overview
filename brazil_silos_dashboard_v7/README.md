...
└── js/
    ...
    ├── charts.js       # histograma + barras horizontais Top 20 município (Chart.js)
...
- **Top 20 municípios por capacidade** — barras horizontais, soma da capacidade (t), do maior para o menor, com o valor em cada barra.
- **Top 20 municípios por quantidade de silos** — barras horizontais, número de silos, do maior para o menor, com o valor em cada barra.
- **Treemap por estado** — participação de cada estado na capacidade total.
